...
const Portal = () => {
  useEffect(() => {
    const grid = document.querySelector(".mason-grid") as Element;
  ...
  return (
    <Layout>
      <div className="mainCt w-full overflow-y-auto px-4 py-5">
        <div className="mx-auto h-full w-full">
          <h1 className="pb-5 text-2xl font-semibold text-[#333]">
            Etkinlikler
          </h1>
          <div className="mason-grid">
            <div className="mason-grid-item group relative mb-5 h-44 w-72 cursor-pointer">
            ...
            <div className="mason-grid-item group mb-5 w-72">
