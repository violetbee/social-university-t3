...
const Stats = () => {
  return (
    <div className="flex w-full divide-x-[1px] rounded-lg border-t-4 border-cyan-600 bg-white shadow-sm">
      <div className="flex h-full w-1/3 justify-between px-5 py-4">
        <div className="flex flex-col gap-1">
          <p className="text-gray-700">Toplam Beğeni</p>
          <div>
            <p className="text-2xl font-bold text-[#6419E6] md:text-3xl lg:text-5xl">
              25.6K
            </p>
            <p className="hidden text-sm text-gray-700/80 sm-m:block">
              geçen aydan %21 daha fazla
            </p>
          </div>
        </div>
        <div className="hidden items-center lg:flex">
          <AiOutlineHeart color={"#6419E6"} size="40" />
        </div>
      </div>
      <div className="flex h-full w-1/3 justify-between px-5 py-4">
