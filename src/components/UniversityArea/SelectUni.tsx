...
export default function SelectUni() {
  ...
  return (
    <div className="relative">
      <div className="z-20 flex min-w-[500px] flex-col items-center justify-center gap-10 rounded-md border border-gray-200 bg-white p-4 shadow-lg dark:border-darkHelper dark:bg-darkSecondary dark:shadow-md">
      ...
      <div className="absolute left-0 top-0 z-0 h-full w-full bg-darkBackground opacity-50" />
    </div>
  );
}
