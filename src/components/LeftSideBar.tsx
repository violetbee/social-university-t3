...
const LeftSideBar: FC = () => {
  return (
    <div className="flex w-48 gap-6 xxs-m:flex-col sm-m:w-80 sm-m:flex-row sm-m:justify-center sm-m:gap-4 sm:w-48 sm:flex-col sm:justify-start lg:w-60">
      <Link href="/">
        <div className="hidden h-28 w-full rounded-lg bg-gradient-to-tr from-blue-700 via-purple-500 to-orange-700 p-4 shadow-sm sm:flex">
      ...
      <div className="w-full space-y-2 rounded-lg bg-white p-4 text-slate-900 shadow-sm">
